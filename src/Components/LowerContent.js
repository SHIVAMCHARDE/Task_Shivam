...
import '../Stylesheets/LowerContent.css'
    ...
    <div className='mcLower'>
      ...
      <div className='leftTable'>
        <div className="upperTable">
          <h5 className="listItems" id='recentapplicantHeading'>Recent Applicants</h5>
          <table>
        ...
        <div className="bottomTable">
          <h5 className="listItems" id='recentapplicantHeading'>Recent Job Listing</h5>
          <table>
            <tr className='TableHeadings'>
      ...
      <div className='rightList'>
        ...
        <h5 className="listItems" id='applicantHeading'>Applicant Review</h5>
        <br />
        ...
        <div className="listItems">
          ...
          <h6 className="applicantsName">Jone Cooper <p className='roleCont'><p className='role'>UI Designer</p> - 8 Yrs Exp</p> </h6>
          <button className='applicantsBtnRejected'>ACCEPT</button>
        </div>
        <div className="listItems">
